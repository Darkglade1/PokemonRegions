...
public class VenusaurAlly extends AbstractPokemonAlly
{
    public static final String ID = PokemonRegions.makeID(Venusaur.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;

    public VenusaurAlly(final float x, final float y, AbstractAllyPokemonCard allyCard) {
        ...
        addMove(MOVE_1, move1Intent, Venusaur.MOVE_1_DAMAGE);
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            ...
            case MOVE_2: {
                ...
                applyToTarget(target, this, new ToxicPower(target,  Venusaur.MOVE_2_TOXIC));
                applyToTarget(target, this, new WeakPower(target, Venusaur.MOVE_2_DEBUFF, false));
                applyToTarget(target, this, new VulnerablePower(target, Venusaur.MOVE_2_DEBUFF, AbstractDungeon.actionManager.turnHasEnded));
                break;
            }
        }
        postTurn();
