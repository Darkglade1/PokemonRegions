...
public class DeoxysAlly extends AbstractPokemonAlly
{
    public static final String ID = PokemonRegions.makeID(Deoxys.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;

    public DeoxysAlly(final float x, final float y, AbstractAllyPokemonCard allyCard) {
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            case MOVE_1: {
                ...
                applyToTarget(adp(), this, new DrawCardNextTurnPower(adp(), Deoxys.MOVE_1_DRAW));
                break;
            }
            case MOVE_2: {
                block(adp(), Deoxys.MOVE_2_BLOCK);
