...
import pokeregions.cards.pokemonAllyCards.act3.Lunatone;
import pokeregions.monsters.AbstractPokemonAlly;

import static pokeregions.PokemonRegions.makeMonsterPath;
import static pokeregions.util.Wiz.*;

public class LunatoneAlly extends AbstractPokemonAlly
{
    public static final String ID = PokemonRegions.makeID(Lunatone.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;

    public LunatoneAlly(final float x, final float y, AbstractAllyPokemonCard allyCard) {
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            case MOVE_1: {
                ...
                applyToTarget(adp(), this, new StrengthPower(adp(), Lunatone.MOVE_1_EFFECT));
                applyToTarget(adp(), this, new DexterityPower(adp(), Lunatone.MOVE_1_EFFECT));
                break;
            }
            case MOVE_2: {
                atb(new AddTemporaryHPAction(adp(), this, Lunatone.MOVE_2_EFFECT));
                break;
            }
        }
        postTurn();
