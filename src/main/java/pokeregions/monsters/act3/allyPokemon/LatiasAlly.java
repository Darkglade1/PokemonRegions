...
public class LatiasAlly extends AbstractPokemonAlly
{
    public static final String ID = PokemonRegions.makeID(Latias.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;
    public LatiasAlly(final float x, final float y, AbstractAllyPokemonCard allyCard) {
        ...
        addMove(MOVE_2, move2Intent, Latias.MOVE_2_DAMAGE);
        defaultMove = MOVE_1;
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            case MOVE_1: {
                block(adp(), Latias.MOVE_1_BLOCK);
                atb(new ScryAction(Latias.MOVE_1_EFFECT));
                break;
            }
            case MOVE_2: {
                ...
                applyToTarget(target, this, new MistBall(target, Latias.MOVE_2_EFFECT, 1));
                break;
            }
        }
        postTurn();
