...
public class AggronAlly extends AbstractPokemonAlly
{
    public static final String ID = PokemonRegions.makeID(Aggron.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;
    public AggronAlly(final float x, final float y, AbstractAllyPokemonCard allyCard) {
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            ...
            case MOVE_2: {
                block(adp(), Aggron.MOVE_2_BLOCK);
                applyToTarget(adp(), this, new ThornsPower(adp(), Aggron.MOVE_2_BUFF));
                break;
            }
        }
        postTurn();
