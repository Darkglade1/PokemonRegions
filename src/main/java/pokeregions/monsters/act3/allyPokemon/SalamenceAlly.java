...
public class SalamenceAlly extends AbstractPokemonAlly
{
    public static final String ID = PokemonRegions.makeID(Salamence.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;
    public SalamenceAlly(final float x, final float y, AbstractAllyPokemonCard allyCard) {
        ...
        addMove(MOVE_1, move1Intent, Salamence.MOVE_1_DAMAGE);
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            ...
            case MOVE_2: {
                applyToTarget(adp(), this, new StrengthPower(adp(), Salamence.MOVE_2_BUFF));
                applyToTarget(adp(), this, new VigorPower(adp(), Salamence.MOVE_2_VIGOR));
                break;
            }
        }
        postTurn();
