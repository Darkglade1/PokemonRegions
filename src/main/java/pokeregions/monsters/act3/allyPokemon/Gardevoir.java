...
public class Gardevoir extends AbstractPokemonAlly
{
    public static final String ID = PokemonRegions.makeID(Gardevoir.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;
    public Gardevoir(final float x, final float y, AbstractAllyPokemonCard allyCard) {
        ...
        addMove(MOVE_2, move2Intent, pokeregions.cards.pokemonAllyCards.act3.Gardevoir.MOVE_2_DAMAGE);
        defaultMove = MOVE_2;
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            case MOVE_1: {
                runAnim("Special");
                applyToTarget(adp(), this, new Fortitude(adp(), pokeregions.cards.pokemonAllyCards.act3.Gardevoir.MOVE_1_EFFECT, false));
                break;
            }
            case MOVE_2: {
                ...
                applyToTarget(target, this, new StrengthPower(target, -pokeregions.cards.pokemonAllyCards.act3.Gardevoir.MOVE_2_EFFECT));
                if (!target.hasPower(ArtifactPower.POWER_ID)) {
                    applyToTarget(target, this, new GainStrengthPower(target, pokeregions.cards.pokemonAllyCards.act3.Gardevoir.MOVE_2_EFFECT));
                }
                break;
            }
        }
