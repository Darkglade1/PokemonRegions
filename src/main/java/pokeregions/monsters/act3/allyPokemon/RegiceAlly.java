...
public class RegiceAlly extends AbstractPokemonAlly
{
    public static final String ID = PokemonRegions.makeID(Regice.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;
    public RegiceAlly(final float x, final float y, AbstractAllyPokemonCard allyCard) {
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            case MOVE_1: {
                block(adp(), Regice.MOVE_1_BLOCK);
                break;
            }
            case MOVE_2: {
                applyToTarget(target, this, new WeakPower(target, Regice.MOVE_2_EFFECT, false));
                applyToTarget(target, this, new VulnerablePower(target, Regice.MOVE_2_EFFECT, AbstractDungeon.actionManager.turnHasEnded));
                break;
            }
        }
        postTurn();
