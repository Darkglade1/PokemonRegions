...
public class CharizardAlly extends AbstractPokemonAlly
{
    public static final String ID = PokemonRegions.makeID(Charizard.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;

    public CharizardAlly(final float x, final float y, AbstractAllyPokemonCard allyCard) {
        ...
        addMove(MOVE_1, move1Intent, Charizard.MOVE_1_DAMAGE);
        addMove(MOVE_2, move2Intent, Charizard.MOVE_2_DAMAGE);
        defaultMove = MOVE_1;
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            case MOVE_1: {
                ...
                applyToTarget(target, this, new Burn(target, Charizard.MOVE_1_DEBUFF));
                break;
            }
            case MOVE_2: {
                runAnim("Ranged");
                ...
                applyToTarget(target, this, new VulnerablePower(target, Charizard.MOVE_2_DEBUFF, AbstractDungeon.actionManager.turnHasEnded));
                applyToTarget(target, this, new Burn(target, Charizard.MOVE_2_DEBUFF));
                break;
            }
        }
        postTurn();
