...
public class TropiusAlly extends AbstractPokemonAlly
{
    public static final String ID = PokemonRegions.makeID(Tropius.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;
    public TropiusAlly(final float x, final float y, AbstractAllyPokemonCard allyCard) {
        ...
        addMove(MOVE_2, Intent.ATTACK_DEBUFF, Tropius.MOVE_2_DAMAGE);
        defaultMove = MOVE_1;
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            case MOVE_1: {
                applyToTarget(adp(), this, new EnergizedPower(adp(),  Tropius.MOVE_1_EFFECT));
                break;
            }
            case MOVE_2: {
                ...
                dmg(target, info);
                applyToTarget(target, this, new WeakPower(target, Tropius.MOVE_2_DEBUFF, false));
                break;
            }
        }
        postTurn();
