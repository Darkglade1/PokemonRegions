...
import pokeregions.cards.pokemonAllyCards.act3.Metagross;
...
public class MetagrossAlly extends AbstractPokemonAlly
{
    public static final String ID = PokemonRegions.makeID(Metagross.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;
    public MetagrossAlly(final float x, final float y, AbstractAllyPokemonCard allyCard) {
        ...
        addMove(MOVE_1, move1Intent, Metagross.MOVE_1_DAMAGE);
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            ...
            case MOVE_2: {
                atb(new DrawCardAction(Metagross.MOVE_2_DRAW));
                break;
            }
        }
        postTurn();
    ...
    public void updateMoveHits() {
        if (this.nextMove == MOVE_1 && allyCard.currentStamina >= move1StaminaCost) {
            ...
            if (numHits == 1) {
                ...
                addMove(MOVE_1, move1Intent, Metagross.MOVE_1_DAMAGE, numHits);
                setMoveShortcut(MOVE_1);
