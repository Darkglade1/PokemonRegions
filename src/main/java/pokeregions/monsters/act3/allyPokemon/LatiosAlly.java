...
public class LatiosAlly extends AbstractPokemonAlly
{
    public static final String ID = PokemonRegions.makeID(Latios.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;
    public LatiosAlly(final float x, final float y, AbstractAllyPokemonCard allyCard) {
        ...
        addMove(MOVE_1, move1Intent, Latios.MOVE_1_DAMAGE);
        addMove(MOVE_2, move2Intent, Latios.MOVE_2_DAMAGE);
        defaultMove = MOVE_1;
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            case MOVE_1: {
                ...
                applyToTarget(target, this, new LusterPurge(target, Latios.MOVE_1_EFFECT, 1, AbstractDungeon.actionManager.turnHasEnded));
                break;
            }
            case MOVE_2: {
                useFastAttackAnimation();
                ...
                for (AbstractMonster mo : Wiz.getEnemies()) {
                    applyToTarget(mo, this, new WeakPower(mo, Latios.MOVE_2_EFFECT, false));
                    applyToTarget(mo, this, new VulnerablePower(mo, Latios.MOVE_2_EFFECT, AbstractDungeon.actionManager.turnHasEnded));
                }
                break;
            }
        }
