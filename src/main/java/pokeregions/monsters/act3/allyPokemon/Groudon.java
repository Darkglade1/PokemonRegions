...
public class Groudon extends AbstractPokemonAlly
{
    public static final String ID = PokemonRegions.makeID(Groudon.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;
    public Groudon(final float x, final float y, AbstractAllyPokemonCard allyCard) {
        ...
        addMove(MOVE_2, move2Intent, pokeregions.cards.pokemonAllyCards.act3.Groudon.MOVE_2_DAMAGE, pokeregions.cards.pokemonAllyCards.act3.Groudon.MOVE_2_HITS);
        defaultMove = MOVE_1;
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            case MOVE_1: {
                atb(new GroudonExhaustDrawPileAction(pokeregions.cards.pokemonAllyCards.act3.Groudon.MOVE_1_EXHAUST, true, target, this));
                break;
            }
            case MOVE_2: {
