...
public class Flygon extends AbstractPokemonAlly
{
    public static final String ID = PokemonRegions.makeID(Flygon.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;
    public Flygon(final float x, final float y, AbstractAllyPokemonCard allyCard) {
        ...
        addMove(MOVE_1, move1Intent, pokeregions.cards.pokemonAllyCards.act3.Flygon.MOVE_1_DAMAGE);
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            case MOVE_1: {
                ...
                applyToTarget(target, this, new Slow(target, pokeregions.cards.pokemonAllyCards.act3.Flygon.MOVE_1_DEBUFF, AbstractDungeon.actionManager.turnHasEnded));
                break;
            }
            case MOVE_2: {
