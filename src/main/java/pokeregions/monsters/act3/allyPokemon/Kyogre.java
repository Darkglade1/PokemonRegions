...
public class Kyogre extends AbstractPokemonAlly
{
    public static final String ID = PokemonRegions.makeID(Kyogre.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;
    public Kyogre(final float x, final float y, AbstractAllyPokemonCard allyCard) {
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            case MOVE_1: {
                atb(new HealAction(adp(), adp(), pokeregions.cards.pokemonAllyCards.act3.Kyogre.MOVE_1_HEAL));
                break;
            }
            case MOVE_2: {
                applyToTarget(target, this, new Drowning(target, pokeregions.cards.pokemonAllyCards.act3.Kyogre.MOVE_2_DEBUFF));
                break;
            }
        }
        postTurn();
