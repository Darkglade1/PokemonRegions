...
public class Slaking extends AbstractPokemonAlly
{
    public static final String ID = PokemonRegions.makeID(Slaking.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;
    public Slaking(final float x, final float y, AbstractAllyPokemonCard allyCard) {
        ...
        addMove(MOVE_2, move2Intent, pokeregions.cards.pokemonAllyCards.act3.Slaking.MOVE_2_DAMAGE);
        defaultMove = MOVE_1;
