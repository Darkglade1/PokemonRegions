...
public class GyaradosAlly extends AbstractPokemonAlly
{
    public static final String ID = PokemonRegions.makeID(Gyarados.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;

    public GyaradosAlly(final float x, final float y, AbstractAllyPokemonCard allyCard) {
        ...
        addMove(MOVE_1, move1Intent, Gyarados.MOVE_1_DAMAGE);
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            case MOVE_1: {
                ...
                atb(new GyaradosWaterfallAction(target, info, this));
                break;
            }
            case MOVE_2: {
                ...
                for (AbstractMonster mo : Wiz.getEnemies()) {
                    applyToTarget(mo, this, new WeakPower(mo, Gyarados.MOVE_2_DEBUFF, false));
                    applyToTarget(mo, this, new VulnerablePower(mo, Gyarados.MOVE_2_DEBUFF, AbstractDungeon.actionManager.turnHasEnded));
                }
                break;
            }
        }
