...
public class ZapdosAlly extends AbstractPokemonAlly
{
    public static final String ID = PokemonRegions.makeID(Zapdos.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;

    public ZapdosAlly(final float x, final float y, AbstractAllyPokemonCard allyCard) {
        ...
        if (numEnemies > 1) {
            addMove(MOVE_1, move1Intent, Zapdos.MOVE_1_DAMAGE, numEnemies);
        } else {
            addMove(MOVE_1, move1Intent, Zapdos.MOVE_1_DAMAGE);
        }
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            ...
            case MOVE_2: {
                atb(new ShuffleDiscardPileBackAction(Zapdos.MOVE_2_EFFECT, true));
                break;
            }
        }
        postTurn();
