...
public class CaterpieAlly extends AbstractPokemonAlly
{
    public static final String ID = PokemonRegions.makeID(Caterpie.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;

    public CaterpieAlly(final float x, final float y, AbstractAllyPokemonCard allyCard) {
        ...
        addMove(MOVE_2, move2Intent, Caterpie.MOVE_2_DAMAGE);
        defaultMove = MOVE_2;
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            case MOVE_1: {
                ...
                applyToTarget(target, this, new StrengthPower(target, -Caterpie.MOVE_1_EFFECT));
                if (!target.hasPower(ArtifactPower.POWER_ID)) {
                    applyToTarget(target, this, new GainStrengthPower(target, Caterpie.MOVE_1_EFFECT));
                }
                break;
            }
            case MOVE_2: {
                ...
                applyToTarget(target, this, new WeakPower(target, Caterpie.MOVE_2_WEAK, false));
                break;
            }
        }
        postTurn();
