...
public class RhyhornAlly extends AbstractPokemonAlly
{
    public static final String ID = PokemonRegions.makeID(Rhyhorn.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;

    public RhyhornAlly(final float x, final float y, AbstractAllyPokemonCard allyCard) {
        ...
        addMove(MOVE_1, move1Intent, Rhyhorn.MOVE_1_DAMAGE);
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            case MOVE_1: {
                ...
                block(adp(), Rhyhorn.MOVE_1_BLOCK);
                break;
            }
            case MOVE_2: {
                block(adp(), Rhyhorn.MOVE_2_BLOCK);
                break;
            }
        }
        postTurn();
