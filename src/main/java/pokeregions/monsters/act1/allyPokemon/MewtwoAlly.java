...
public class MewtwoAlly extends AbstractPokemonAlly
{
    public static final String ID = PokemonRegions.makeID(Mewtwo.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;

    public MewtwoAlly(final float x, final float y, AbstractAllyPokemonCard allyCard) {
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            case MOVE_1: {
                atb(new ChannelAction(new MewtwoDark(Mewtwo.MOVE_1_INCREASE)));
                break;
            }
            case MOVE_2: {
                ...
                for (int i = 0; i < Mewtwo.MOVE_2_EFFECT - 1; i++) {
