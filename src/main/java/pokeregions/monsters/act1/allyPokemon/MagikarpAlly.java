...
public class MagikarpAlly extends AbstractPokemonAlly
{
    ...
    public MagikarpAlly(final float x, final float y, AbstractAllyPokemonCard allyCard) {
        ...
        addMove(MOVE_2, move2Intent, Magikarp.MOVE_2_DAMAGE);
        defaultMove = MOVE_1;
