...
public class GolemAlly extends AbstractPokemonAlly
{
    public static final String ID = PokemonRegions.makeID(Golem.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;

    public GolemAlly(final float x, final float y, AbstractAllyPokemonCard allyCard) {
        ...
        addMove(MOVE_2, move2Intent, Golem.MOVE_2_DAMAGE);
        defaultMove = MOVE_1;
    }
