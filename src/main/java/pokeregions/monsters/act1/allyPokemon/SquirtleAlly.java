...
public class SquirtleAlly extends AbstractPokemonAlly
{
    public static final String ID = PokemonRegions.makeID(Squirtle.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;

    public SquirtleAlly(final float x, final float y, AbstractAllyPokemonCard allyCard) {
        ...
        addMove(MOVE_1, move1Intent, Squirtle.MOVE_1_DAMAGE);
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            ...
            case MOVE_2: {
                runAnim("Defense");
                block(adp(), Squirtle.MOVE_2_BLOCK);
                break;
            }
        }
        postTurn();
