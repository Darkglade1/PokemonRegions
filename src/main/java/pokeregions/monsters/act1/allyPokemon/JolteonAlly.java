...
public class JolteonAlly extends AbstractPokemonAlly
{
    public static final String ID = PokemonRegions.makeID(Jolteon.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;

    public JolteonAlly(final float x, final float y, AbstractAllyPokemonCard allyCard) {
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            case MOVE_1: {
                applyToTarget(adp(), this, new DexterityPower(adp(),  Jolteon.MOVE_1_DEX));
                break;
            }
            case MOVE_2: {
                applyToTarget(adp(), this, new EnergizedPower(adp(),  Jolteon.MOVE_2_ENERGY));
                break;
            }
        }
        postTurn();
