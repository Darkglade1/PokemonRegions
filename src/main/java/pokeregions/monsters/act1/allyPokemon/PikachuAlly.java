...
import pokeregions.cards.pokemonAllyCards.act1.Pikachu;
import pokeregions.monsters.AbstractPokemonAlly;

import static pokeregions.PokemonRegions.makeMonsterPath;
import static pokeregions.util.Wiz.*;

public class PikachuAlly extends AbstractPokemonAlly
{
    public static final String ID = PokemonRegions.makeID(Pikachu.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;

    public PikachuAlly(final float x, final float y, AbstractAllyPokemonCard allyCard) {
        ...
        addMove(MOVE_2, move2Intent, Pikachu.MOVE_2_DAMAGE);
        defaultMove = MOVE_1;
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            ...
            case MOVE_2: {
                ...
                dmg(target, info);
                applyToTarget(target, this, new WeakPower(target, Pikachu.MOVE_2_DEBUFF, false));
                applyToTarget(target, this, new VulnerablePower(target, Pikachu.MOVE_2_DEBUFF, AbstractDungeon.actionManager.turnHasEnded));
                break;
            }
        }
        postTurn();
