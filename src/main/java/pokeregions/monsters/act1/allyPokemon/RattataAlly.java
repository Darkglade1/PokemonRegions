...
public class RattataAlly extends AbstractPokemonAlly
{
    public static final String ID = PokemonRegions.makeID(Rattata.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;

    public RattataAlly(final float x, final float y, AbstractAllyPokemonCard allyCard) {
        ...
        addMove(MOVE_1, move1Intent, Rattata.MOVE_1_DAMAGE);
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            case MOVE_1: {
                ...
                atb(new DrawCardAction(adp(), Rattata.MOVE_1_DRAW));
                break;
            }
            case MOVE_2: {
                block(adp(), Rattata.MOVE_2_BLOCK);
                atb(new DrawCardAction(adp(), Rattata.MOVE_2_DRAW));
                break;
            }
        }
        postTurn();
