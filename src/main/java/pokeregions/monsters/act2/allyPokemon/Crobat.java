...
public class Crobat extends AbstractPokemonAlly
{
    ...
    public Crobat(final float x, final float y, AbstractAllyPokemonCard allyCard) {
        ...
        addMove(MOVE_2, move2Intent, pokeregions.cards.pokemonAllyCards.act2.Crobat.MOVE_2_DAMAGE);
        defaultMove = MOVE_2;
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            ...
            case MOVE_2: {
                ...
                atb(new DrawCardAction(pokeregions.cards.pokemonAllyCards.act2.Crobat.MOVE_2_DRAW));
                break;
            }
        }
        postTurn();
