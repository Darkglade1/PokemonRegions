...
public class Steelix extends AbstractPokemonAlly
{
    public static final String ID = PokemonRegions.makeID(Steelix.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;
    public Steelix(final float x, final float y, AbstractAllyPokemonCard allyCard) {
        ...
        addMove(MOVE_1, move1Intent, pokeregions.cards.pokemonAllyCards.act2.Steelix.MOVE_1_DAMAGE);
    ...
    public void usePreBattleAction() {
        ...
        addMove(MOVE_1, move1Intent, pokeregions.cards.pokemonAllyCards.act2.Steelix.MOVE_1_DAMAGE + (int)(adp().currentBlock * ((float)pokeregions.cards.pokemonAllyCards.act2.Steelix.MOVE_1_EFFECT / 100)));
    }
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            ...
            case MOVE_2: {
                applyToTarget(adp(), this, new DrawPower(adp(), pokeregions.cards.pokemonAllyCards.act2.Steelix.MOVE_2_EFFECT));
                break;
            }
        }
        postTurn();
