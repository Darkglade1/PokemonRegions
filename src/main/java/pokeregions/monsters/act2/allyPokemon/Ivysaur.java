...
public class Ivysaur extends AbstractPokemonAlly
{
    public static final String ID = PokemonRegions.makeID(Ivysaur.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;

    public Ivysaur(final float x, final float y, AbstractAllyPokemonCard allyCard) {
        ...
        addMove(MOVE_1, move1Intent, pokeregions.cards.pokemonAllyCards.act2.Ivysaur.MOVE_1_DAMAGE);
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            ...
            case MOVE_2: {
                ...
                applyToTarget(target, this, new ToxicPower(target,  pokeregions.cards.pokemonAllyCards.act2.Ivysaur.MOVE_2_TOXIC));
                applyToTarget(target, this, new WeakPower(target, pokeregions.cards.pokemonAllyCards.act2.Ivysaur.MOVE_2_WEAK, false));
                break;
            }
        }
        postTurn();
