...
public class WartortleAlly extends AbstractPokemonAlly
{
    public static final String ID = PokemonRegions.makeID(Wartortle.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;

    public WartortleAlly(final float x, final float y, AbstractAllyPokemonCard allyCard) {
        ...
        addMove(MOVE_1, move1Intent, Wartortle.MOVE_1_DAMAGE);
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            ...
            case MOVE_2: {
                block(adp(), Wartortle.MOVE_2_BLOCK);
                break;
            }
        }
        postTurn();
