...
public class LugiaAlly extends AbstractPokemonAlly
{
    public static final String ID = PokemonRegions.makeID(Lugia.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;
    public LugiaAlly(final float x, final float y, AbstractAllyPokemonCard allyCard) {
        ...
        addMove(MOVE_1, move1Intent, Lugia.MOVE_1_DAMAGE);
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            ...
            case MOVE_2: {
                applyToTarget(target, this, new StrengthPower(target, -Lugia.MOVE_2_EFFECT));
                break;
            }
        }
        postTurn();
