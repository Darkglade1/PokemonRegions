...
public class MagcargoAlly extends AbstractPokemonAlly
{
    public static final String ID = PokemonRegions.makeID(Magcargo.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;

    public MagcargoAlly(final float x, final float y, AbstractAllyPokemonCard allyCard) {
        ...
        addMove(MOVE_1, move1Intent, Magcargo.MOVE_1_DAMAGE, Magcargo.MOVE_1_HITS);
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            ...
            case MOVE_2: {
                block(adp(), Magcargo.MOVE_2_BLOCK);
                makeInHand(new com.megacrit.cardcrawl.cards.status.Burn(), Magcargo.MOVE_2_STATUS);
                break;
            }
        }
        postTurn();
