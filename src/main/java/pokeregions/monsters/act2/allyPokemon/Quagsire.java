...
public class Quagsire extends AbstractPokemonAlly
{
    public static final String ID = PokemonRegions.makeID(Quagsire.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;

    public Quagsire(final float x, final float y, AbstractAllyPokemonCard allyCard) {
        ...
        addMove(MOVE_2, move2Intent, pokeregions.cards.pokemonAllyCards.act2.Quagsire.MOVE_2_DAMAGE);
        defaultMove = MOVE_2;
    }
        ...
        switch (this.nextMove) {
            ...
            case MOVE_2: {
                ...
                for (AbstractMonster mo : Wiz.getEnemies()) {
                    applyToTarget(mo, this, new WeakPower(mo, pokeregions.cards.pokemonAllyCards.act2.Quagsire.MOVE_2_EFFECT, false));
                    applyToTarget(mo, this, new Burn(mo, pokeregions.cards.pokemonAllyCards.act2.Quagsire.MOVE_2_EFFECT));
                }
                break;
            }
        }
