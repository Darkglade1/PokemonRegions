...
public class Celebi extends AbstractPokemonAlly
{
    ...
    public Celebi(final float x, final float y, AbstractAllyPokemonCard allyCard) {
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            ...
            case MOVE_2: {
                atb(new DrawCardAction(pokeregions.cards.pokemonAllyCards.act2.Celebi.MOVE_2_EFFECT, new AbstractGameAction() {
                    @Override
                    public void update() {
                        int totalCost = 0;
                        ...
                        if (totalCost > 0) {
                            atb(new AddTemporaryHPAction(adp(), Celebi.this, totalCost));
                        }
                        this.isDone = true;
                    }
                }));
