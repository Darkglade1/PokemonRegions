...
public class AzumarillAlly extends AbstractPokemonAlly
{
    public static final String ID = PokemonRegions.makeID(Azumarill.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;

    public AzumarillAlly(final float x, final float y, AbstractAllyPokemonCard allyCard) {
        ...
        addMove(MOVE_2, move2Intent, Azumarill.MOVE_2_DAMAGE);
        defaultMove = MOVE_1;
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            case MOVE_1: {
                applyToTarget(this, this, new Courage(this, Azumarill.MOVE_1_EFFECT));
                break;
            }
            case MOVE_2: {
