...
public class Kingdra extends AbstractPokemonAlly
{
    public static final String ID = PokemonRegions.makeID(Kingdra.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;

    public Kingdra(final float x, final float y, AbstractAllyPokemonCard allyCard) {
        ...
        addMove(MOVE_2, move2Intent, pokeregions.cards.pokemonAllyCards.act2.Kingdra.MOVE_2_DAMAGE);
        defaultMove = MOVE_2;
    }
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            case MOVE_1: {
                applyToTarget(adp(), this, new Concentrate(adp(), pokeregions.cards.pokemonAllyCards.act2.Kingdra.MOVE_1_EFFECT));
                break;
            }
            case MOVE_2: {
