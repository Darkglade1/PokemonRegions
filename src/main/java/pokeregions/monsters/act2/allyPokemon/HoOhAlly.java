...
public class HoOhAlly extends AbstractPokemonAlly
{
    public static final String ID = PokemonRegions.makeID(HoOh.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;
    public HoOhAlly(final float x, final float y, AbstractAllyPokemonCard allyCard) {
        ...
        addMove(MOVE_2, move2Intent, HoOh.MOVE_2_DAMAGE);
        defaultMove = MOVE_2;
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            case MOVE_1: {
                applyToTarget(adp(), this, new RegenPower(adp(), HoOh.MOVE_1_EFFECT));
                break;
            }
            case MOVE_2: {
