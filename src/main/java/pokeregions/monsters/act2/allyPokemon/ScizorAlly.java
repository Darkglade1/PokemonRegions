...
public class ScizorAlly extends AbstractPokemonAlly
{
    ...
    public ScizorAlly(final float x, final float y, AbstractAllyPokemonCard allyCard) {
        ...
        addMove(MOVE_1, move1Intent, Scizor.MOVE_1_DAMAGE);
        addMove(MOVE_2, move2Intent, Scizor.MOVE_2_DAMAGE, 2);
        defaultMove = MOVE_1;
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            case MOVE_1: {
                ...
                applyToTarget(adp(), this, new AbstractLambdaPower(POWER_ID, POWER_NAME, AbstractPower.PowerType.BUFF, false, adp(), Scizor.MOVE_1_EFFECT, "retain", 99) {
                    @Override
    ...
    public void updateMoveFromCardsPlayed() {
        if (this.nextMove == MOVE_2 && allyCard.currentStamina >= move2StaminaCost) {
            ...
            addMove(MOVE_2, move2Intent, Scizor.MOVE_2_DAMAGE, totalAttacks);
