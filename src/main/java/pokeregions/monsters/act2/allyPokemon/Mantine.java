...
public class Mantine extends AbstractPokemonAlly
{
    public static final String ID = PokemonRegions.makeID(Mantine.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;

    public Mantine(final float x, final float y, AbstractAllyPokemonCard allyCard) {
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            case MOVE_1: {
                applyToTarget(adp(), this, new ArtifactPower(adp(), pokeregions.cards.pokemonAllyCards.act2.Mantine.MOVE_1_EFFECT));
                break;
            }
            case MOVE_2: {
                for (AbstractMonster mo : Wiz.getEnemies()) {
                    applyToTarget(mo, this, new WeakPower(mo, pokeregions.cards.pokemonAllyCards.act2.Mantine.MOVE_2_EFFECT, false));
                }
                break;
            }
        }
