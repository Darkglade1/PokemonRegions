...
public class Phanpy extends AbstractPokemonAlly
{
    public static final String ID = PokemonRegions.makeID(Phanpy.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;

    public Phanpy(final float x, final float y, AbstractAllyPokemonCard allyCard) {
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            ...
            case MOVE_2: {
                atb(new DrawCardAction(pokeregions.cards.pokemonAllyCards.act2.Phanpy.MOVE_2_EFFECT, new AbstractGameAction() {
                    @Override
                    public void update() {
