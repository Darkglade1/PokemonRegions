...
public class Dialga extends AbstractPokemonAlly
{
    public static final String ID = PokemonRegions.makeID(Dialga.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;
    public Dialga(final float x, final float y, AbstractAllyPokemonCard allyCard) {
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            case MOVE_1: {
                applyToTarget(adp(), this, new Rewind(adp(), pokeregions.cards.pokemonAllyCards.act4.Dialga.MOVE_1_EFFECT));
                break;
            }
            case MOVE_2: {
