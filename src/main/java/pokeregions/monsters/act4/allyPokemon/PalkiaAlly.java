...
import pokeregions.cards.pokemonAllyCards.act4.Palkia;
...
public class PalkiaAlly extends AbstractPokemonAlly
{
    public static final String ID = PokemonRegions.makeID(Palkia.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;
    public PalkiaAlly(final float x, final float y, AbstractAllyPokemonCard allyCard) {
