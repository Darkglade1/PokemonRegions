...
import pokeregions.monsters.act1.allyPokemon.AlakazamAlly;
...
public class Alakazam extends AbstractAllyPokemonCard {
    ...
    public Alakazam() {
        ...
        this.move2Description = DESCRIPTIONS[5] + MOVE_2_SCRY + DESCRIPTIONS[6] + MOVE_2_DRAW + DESCRIPTIONS[7];
        initializeDescriptionFromMoves();
    }

    @Override
    public AbstractPokemonAlly getAssociatedPokemon(float x, float y) {
        return new AlakazamAlly(x, y, this);
    }
}