...
import pokeregions.monsters.act3.allyPokemon.GardevoirAlly;
...
public class Gardevoir extends AbstractAllyPokemonCard {
    ...
    public Gardevoir() {
        ...
        this.move2Description = DESCRIPTIONS[4] + MOVE_2_DAMAGE + DESCRIPTIONS[5] + MOVE_2_EFFECT + DESCRIPTIONS[6];
        initializeDescriptionFromMoves();
    }

    @Override
    public AbstractPokemonAlly getAssociatedPokemon(float x, float y) {
        return new GardevoirAlly(x, y, this);
    }
}