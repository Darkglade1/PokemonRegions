...
import pokeregions.monsters.act3.allyPokemon.SolrockAlly;

import static pokeregions.PokemonRegions.makeID;

@NoPools
public class Solrock extends AbstractAllyPokemonCard {
    public final static String ID = makeID(Solrock.class.getSimpleName());
    ...
    public AbstractPokemonAlly getAssociatedPokemon(float x, float y) {
        return new SolrockAlly(x, y, this);
    }
}