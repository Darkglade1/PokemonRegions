...
@NoPools
public class Metagross extends AbstractAllyPokemonCard {
    public final static String ID = makeID(Metagross.class.getSimpleName());
    ...
    public Metagross() {
        ...
        this.move2Description = DESCRIPTIONS[4] + MOVE_2_DRAW + DESCRIPTIONS[5];
