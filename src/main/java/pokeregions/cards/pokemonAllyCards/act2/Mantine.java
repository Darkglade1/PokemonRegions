...
import pokeregions.monsters.act2.allyPokemon.MantineAlly;

import static pokeregions.PokemonRegions.makeID;

@NoPools
public class Mantine extends AbstractAllyPokemonCard {
    public final static String ID = makeID(Mantine.class.getSimpleName());
    ...
    public AbstractPokemonAlly getAssociatedPokemon(float x, float y) {
        return new MantineAlly(x, y, this);
    }
}