...
import pokeregions.monsters.act2.allyPokemon.CelebiAlly;

import static pokeregions.PokemonRegions.makeID;

@NoPools
public class Celebi extends AbstractAllyPokemonCard {
    public final static String ID = makeID(Celebi.class.getSimpleName());
    ...
    public AbstractPokemonAlly getAssociatedPokemon(float x, float y) {
        return new CelebiAlly(x, y, this);
    }
}