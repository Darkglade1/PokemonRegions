...
import pokeregions.monsters.act2.allyPokemon.HoOhAlly;

import static pokeregions.PokemonRegions.makeID;

@NoPools
public class HoOh extends AbstractAllyPokemonCard {
    public final static String ID = makeID(HoOh.class.getSimpleName());
