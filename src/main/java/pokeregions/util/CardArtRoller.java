...
public class CardArtRoller {
    private static final Texture attackMask = TexLoader.getTexture(PokemonRegions.makeImagePath("masks/AttackMask.png"));
    private static final Texture skillMask = TexLoader.getTexture(PokemonRegions.makeImagePath("masks/SkillMask.png"));
    private static final Texture powerMask = TexLoader.getTexture(PokemonRegions.makeImagePath("masks/PowerMask.png"));
