...
public class Charmander extends AbstractPokemonAlly
{
    ...
    public Charmander(final float x, final float y, AbstractAllyPokemonCard allyCard) {
        ...
        addMove(MOVE_1, Intent.ATTACK, code.cards.pokemonAllyCards.Charmander.MOVE_1_DAMAGE);
        addMove(MOVE_2, IntentEnums.MASS_ATTACK, code.cards.pokemonAllyCards.Charmander.MOVE_2_DAMAGE);
        defaultMove = MOVE_1;
